/**
P23_IOC.X
il progetto prevede la realizzazione di un gioco luci che si attivi alla 
pressione del pulsante S1 collegato al PIN RB0 attraverso il meccanismo dell'Interrupt On Change (IOC),
