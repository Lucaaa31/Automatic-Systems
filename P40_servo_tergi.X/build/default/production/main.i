...
void main(void)
{
    ...
    while (1){
      ...
      _delay((unsigned long)((500)*(2000000/4000.0)));
        ...
        if(PORTAbits.RA2==1){a=1;}
        if(PORTAbits.RA3==1){a=2;}
        if(PORTAbits.RA4==1){a=3;}
        if(PORTAbits.RA2==1 && PORTAbits.RA3==1){a=4;}

        switch(a){
            case 1:
                EPWM1_LoadDutyValue(69);
                EPWM2_LoadDutyValue(69);
                _delay((unsigned long)((4000)*(2000000/4000.0)));
                break;
            case 2:
                EPWM1_LoadDutyValue(69);
                EPWM2_LoadDutyValue(69);
                _delay((unsigned long)((2000)*(2000000/4000.0)));
                break;
            case 3:
                EPWM1_LoadDutyValue(69);
                EPWM2_LoadDutyValue(69);
