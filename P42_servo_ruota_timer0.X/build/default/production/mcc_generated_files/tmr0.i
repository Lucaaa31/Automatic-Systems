...
void TMR0_ISR(void)
{
    ...
    if(TMR0_InterruptHandler)
    {
      ...
      if(PORTAbits.RA2==1 && PORTAbits.RA3==0 && PORTAbits.RA4==0){a=1;}
      if(PORTAbits.RA2==0 && PORTAbits.RA3==1 && PORTAbits.RA4==0){a=2;}
      if(PORTAbits.RA2==0 && PORTAbits.RA3==0 && PORTAbits.RA4==1){a=3;}
      while(a==1){
          t=t+1;
          if(t>=100){
          duty=duty+30;
          ...
          if(PORTAbits.RA2==1 && PORTAbits.RA3==1 && PORTAbits.RA4==1){duty=16;a=4;}
      }
      while(a==2){
          t=t+1;
          if(t>=60 && t<=100){
