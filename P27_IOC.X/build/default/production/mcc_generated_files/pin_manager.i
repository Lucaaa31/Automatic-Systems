...
# 33 "mcc_generated_files/pin_manager.c"
...
# 367 "mcc_generated_files/pin_manager.h"
...
# 34 "mcc_generated_files/pin_manager.c" 2
...
void PIN_MANAGER_IOC(void)
{
    ...
    if(IOCBFbits.IOCBF0 == 1 && IOCBFbits.IOCBF1 == 1){
        ...
        _delay((unsigned long)((6000)*(4000000/4000.0)));
        IOCBF0_ISR();
    }
