...
/*
    P19_timer0_supercar_COGNOME_CLASSE.X
Creare un nuovo progetto che preveda l'esecuzione del gioco-luci SUPERCAR (accensione in sequenza di un solo LED alla volta, avanti/indietro) ogni 5 secondi con tempo scandito dal timer0,
impostato da MCC.
