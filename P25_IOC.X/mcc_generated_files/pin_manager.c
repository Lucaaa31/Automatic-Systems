 ...
 * da 37 a 60, dichiarazione funzioni dei giochi;
 * da 147 a 149 e da 179 a 181, funzione dentro a IOCBF0_ISR() e IOCBF1_ISR().
*/
...
void Supercar(){
    int i;
    __delay_ms(200);
    Display=0b00000100;  //accendo penultimo led
    for(i=2;i<7;i++)  //ciclo che si ripete 7 volte
    {
