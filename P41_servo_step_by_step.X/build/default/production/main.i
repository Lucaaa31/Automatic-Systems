...
void main(void)
{
    ...
    while (1){
            ...
            do{
                ...
                if(PORTAbits.RA2==1){duty=duty-3;if(duty<22){PORTBbits.RB4=1;}}
                if(PORTAbits.RA3==1){duty=duty+3;if(duty>80){PORTBbits.RB2=1;}}
        }while(duty>=22 && duty<=80);
        if(PORTAbits.RA4==1){duty=80;}
    }
}
